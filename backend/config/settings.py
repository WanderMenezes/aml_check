...
SCREENING_SETTINGS = {
    ...
    "MIN_EXTERNAL_SCORE": env_int("SCREENING_MIN_EXTERNAL_SCORE", 85),
    "EXTERNAL_CACHE_TTL": env_int("SCREENING_EXTERNAL_CACHE_TTL", 300),
    "EXTERNAL_CONCURRENCY": env_int("SCREENING_EXTERNAL_CONCURRENCY", 8),
    "EXTERNAL_MAX_BYTES": env_int("SCREENING_EXTERNAL_MAX_BYTES", 750000),
}
